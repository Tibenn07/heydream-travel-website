...
=======
                    <div class="form-group"><label>Email ${window.currentUserEmail ? '(Your Account Email)' : '*'}</label><input type="email" id="foreignStepEmail" placeholder="your.email@example.com" value="${window.currentUserEmail || ''}" ${window.currentUserEmail ? 'readonly style="background-color:#f0f0f0;cursor:not-allowed;"' : ''}></div>
                </div>
                <div class="form-row">
