            ...
            <div class="booking-form-modal">
                ...
                <div class="form-group" style="margin-top:20px;">
                    ...
                    <div class="hotel-selection-item" onclick="toggleHomeHotelSelection()" style="cursor:pointer; border:1px solid #ddd; border-radius:8px; padding:12px 15px; display:flex; align-items:center; justify-content:space-between;">
                        <span><i class="fas fa-hotel" style="color:#ff9800; margin-right:8px;"></i><span id="homeSelectedHotelName" style="font-weight:600;">${escapeHtml(destination.hotels[0].name)}${destination.hotels[0].stars ? ' ' + '⭐'.repeat(destination.hotels[0].stars) : ''}</span></span>
