...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 14, 2026 at 03:52 AM
...
(26, 'Gelo', 'angelomarc@gmail.com', 'Angelo', '$2y$10$S1cHbF6gsBWjoTzTMEPgAuP1qIYrlSbh07w59mOktFV3uEaztcCXK', 'sales', 'ea7f7d8f18b825bba887319086d3d972af954c9180cb7b49b59b8d9d42e2ecf8', 'rejected', '2026-06-01 12:06:33', '2026-07-01 06:16:59', 1, '');
...
(1, 'superadmin', 'heydreamtravelandtours@gmail.com', '$2y$10$x.EbJLOSYEG8D.H9guUTm.u3s9kwCqYpT4sc1Tg0P54O7nGGdR4G6', 'Super Administrator', 'super_admin', 1, 1, '2026-07-13 18:48:43', NULL, NULL, '2026-07-01 14:16:35', '2026-03-23 05:21:35', '2026-07-13 10:48:43'),
...
(760, 'hd_idx_8u4afqkxx_1779411800353', 'ai', '👋 Hi there! Welcome to <strong>HeyDream Travel and Tours!</strong><br>I\'m <strong>HeyDream AI</strong>, your personal travel assistant. 😊<br><br>How can I help you today? Do you have a destination in mind, or would you like to know more about our packages? ✈️🌏', '2026-07-09 08:34:29', 0),
(761, 'hd_idx_8u4afqkxx_1779411800353', 'customer', 'hiii', '2026-07-09 08:34:31', 1),
(762, 'hd_idx_8u4afqkxx_1779411800353', 'ai', '👋 Hi there! Welcome to <strong>HeyDream Travel and Tours!</strong><br>I\'m <strong>HeyDream AI</strong>, your personal travel assistant. 😊<br><br>How can I help you today? Do you have a destination in mind, or would you like to know more about our packages? ✈️🌏', '2026-07-09 08:34:51', 0),
(763, 'hd_idx_8u4afqkxx_1779411800353', 'customer', 'kh', '2026-07-09 08:34:55', 1),
(764, 'hd_idx_8u4afqkxx_1779411800353', 'ai', '👋 Hi there! Welcome to <strong>HeyDream Travel and Tours!</strong><br>I\'m <strong>HeyDream AI</strong>, your personal travel assistant. 😊<br><br>How can I help you today? Do you have a destination in mind, or would you like to know more about our packages? ✈️🌏', '2026-07-10 01:16:34', 0),
(765, 'hd_idx_8u4afqkxx_1779411800353', 'customer', 'x', '2026-07-10 01:16:37', 1),
(766, 'hd_idx_8u4afqkxx_1779411800353', 'system', '[AGENT_JOINED]', '2026-07-10 01:16:52', 0),
(767, 'hd_idx_8u4afqkxx_1779411800353', 'ai', '👋 Hi there! Welcome to <strong>HeyDream Travel and Tours!</strong><br>I\'m <strong>HeyDream AI</strong>, your personal travel assistant. 😊<br><br>How can I help you today? Do you have a destination in mind, or would you like to know more about our packages? ✈️🌏', '2026-07-10 03:07:10', 0),
(768, 'hd_idx_8u4afqkxx_1779411800353', 'ai', '👋 Hi there! Welcome to <strong>HeyDream Travel and Tours!</strong><br>I\'m <strong>HeyDream AI</strong>, your personal travel assistant. 😊<br><br>How can I help you today? Do you have a destination in mind, or would you like to know more about our packages? ✈️🌏', '2026-07-10 04:12:36', 0),
(769, 'hd_idx_8u4afqkxx_1779411800353', 'customer', 'sdf', '2026-07-10 04:14:55', 1),
(770, 'hd_idx_8u4afqkxx_1779411800353', 'admin', 'sdf', '2026-07-10 04:15:05', 0),
(771, 'hd_idx_8u4afqkxx_1779411800353', 'ai', '👋 Hi there! Welcome to <strong>HeyDream Travel and Tours!</strong><br>I\'m <strong>HeyDream AI</strong>, your personal travel assistant. 😊<br><br>How can I help you today? Do you have a destination in mind, or would you like to know more about our packages? ✈️🌏', '2026-07-10 04:15:25', 0),
(772, 'hd_idx_8u4afqkxx_1779411800353', 'customer', 'What destinations do you offer?', '2026-07-10 04:15:27', 1),
(773, 'hd_idx_8u4afqkxx_1779411800353', 'customer', 'hi', '2026-07-10 04:15:31', 1),
(774, 'hd_idx_8u4afqkxx_1779411800353', 'ai', '👋 Hi there! Welcome to <strong>HeyDream Travel and Tours!</strong><br>I\'m <strong>HeyDream AI</strong>, your personal travel assistant. 😊<br><br>How can I help you today? Do you have a destination in mind, or would you like to know more about our packages? ✈️🌏', '2026-07-10 04:36:18', 0);
...
INSERT INTO `ai_chat_sessions` (`session_id`, `customer_name`, `customer_email`, `status`, `assigned_agent_id`, `last_activity`, `created_at`, `customer_last_typing`, `admin_last_typing`) VALUES
('hd_idx_8u4afqkxx_1779411800353', 'Guest', '', 'active', NULL, '2026-07-13 07:47:02', '2026-07-09 08:34:29', NULL, NULL);
...
CREATE TABLE `bookings` (
  ...
  `partner_package_id` int(11) DEFAULT NULL,
...
INSERT INTO `bookings` (`id`, `user_id`, `booking_number`, `destination_name`, `package_name`, `package_duration`, `price_per_person`, `full_name`, `email`, `phone`, `address`, `travel_date`, `number_of_travelers`, `special_requests`, `flight_details`, `admin_notes`, `total_amount`, `currency`, `booking_status`, `payment_status`, `payment_method`, `payment_reference`, `payment_proof`, `payment_processed`, `travel_documents`, `ready_for_travel`, `reminder_sent`, `created_at`, `updated_at`, `deleted_at`, `visa_status`, `marketing_consent`, `partner_id`, `partner_company`, `partner_package_id`, `partner_package_name`, `partner_source`, `confirmed_by`, `confirmed_at`, `completed_by`, `completed_at`, `cancelled_by`, `cancelled_at`, `partner_approved`) VALUES
(42, 6, 'FO-89118920260512', 'Foreign Destination', '4D3N EXPLORE SINGAPORE F&E', '4D/3N', 265.00, 'Angela Lou G. Dela Cruz', 'angelaloudelacruz7@gmail.com', '+639079128442', NULL, '2026-05-20', 1, '', '', '', 265.00, '$', 'completed', 'paid', 'gcash', '12345', 'uploads/receipts/REC_6a0386588f6a3_20260512.jpg', 0, 1, 1, 0, '2026-05-12 11:58:16', '2026-07-08 02:22:07', NULL, 'APPROVED', 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1),
(46, 6, 'VI-F5DAEE20260513', 'Visa Assistance', 'Singapore', 'Regular', 999.00, 'Angela Lou Dela Cruz', 'angelaloudelacruz7@gmail.com', '09463435820', NULL, '2026-05-17', 1, 'Passport: P1234567A, DOB: 2003-11-05, Address: angelaloudelacruz7@gmail.com, Destination: Singapore, Embassy: manila, Occupation: , Travel History: ', '', '', 999.00, '₱', 'completed', 'paid', 'Manual Agent Approval', 'PENDING_AGENT', NULL, 0, 1, 1, 0, '2026-05-12 16:08:15', '2026-07-08 02:22:07', NULL, 'APPROVED', 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1),
(48, 6, 'FO-FA655F20260513', 'Foreign Destination', '3D2N HKG FREE 7 EASY (HKFE-3D)', '3D2N', 105.00, 'Angela Lou Dela Cruz', 'angelaloudelacruz7@gmail.com', '09091236650', NULL, '2026-05-20', 1, '', '', '', 105.00, '$', 'completed', 'paid', 'gcash', '12345', 'uploads/receipts/REC_6a03caefa4358_20260513.jpg', 0, 1, 1, 0, '2026-05-12 16:50:55', '2026-07-08 02:22:07', NULL, 'APPROVED', 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1),
(52, 6, 'FO-89118920260512', 'Foreign Destination', '4D3N EXPLORE SINGAPORE F&E', '4D/3N', 265.00, 'Angela Lou G. Dela Cruz', 'angelaloudelacruz7@gmail.com', '+639079128442', NULL, '2026-05-20', 1, '', '', '', 265.00, '$', 'completed', 'paid', 'gcash', '12345', 'uploads/receipts/REC_6a0386588f6a3_20260512.jpg', 0, 1, 1, 0, '2026-05-12 11:58:16', '2026-07-08 08:48:57', NULL, 'APPROVED', 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1),
(55, 6, 'VI-F5DAEE20260513', 'Visa Assistance', 'Singapore', 'Regular', 999.00, 'Angela Lou Dela Cruz', 'angelaloudelacruz7@gmail.com', '09463435820', NULL, '2026-05-17', 1, 'Passport: P1234567A, DOB: 2003-11-05, Address: angelaloudelacruz7@gmail.com, Destination: Singapore, Embassy: manila, Occupation: , Travel History: ', '', '', 999.00, '₱', 'completed', 'paid', 'Manual Agent Approval', 'PENDING_AGENT', NULL, 0, 1, 1, 0, '2026-05-12 16:08:15', '2026-07-08 08:48:57', NULL, 'APPROVED', 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1),
(56, 6, 'FO-FA655F20260513', 'Foreign Destination', '3D2N HKG FREE 7 EASY (HKFE-3D)', '3D2N', 105.00, 'Angela Lou Dela Cruz', 'angelaloudelacruz7@gmail.com', '09091236650', NULL, '2026-05-20', 1, '', '', '', 105.00, '$', 'completed', 'paid', 'gcash', '12345', 'uploads/receipts/REC_6a03caefa4358_20260513.jpg', 0, 1, 1, 0, '2026-05-12 16:50:55', '2026-07-08 08:48:57', NULL, 'APPROVED', 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1),
(60, NULL, 'INQ-73D36C20260706', 'tour-package', 'Japan', 'N/A', 0.00, 'Rebancos, Steven', 'rebancossteven35@gmail.com', '+639919612457', NULL, '2026-07-07', 1, 'Destination: Japan\nTravel Type: tour-package\nBudget: 10k-20k\nHotel Preference: Not specified\n\nHow did you hear about us: Twitter', '', '', 0.00, '₱', 'confirmed', 'paid', 'Inquiry Only', NULL, NULL, 0, 0, 0, 1, '2026-07-06 06:22:15', '2026-07-08 08:48:57', NULL, 'PENDING', 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1),
(61, NULL, 'INQ-5685C720260706', 'tour-package', 'Japan', 'N/A', 0.00, 'John KOstya Asuela', 'asuelajohnkostya@gmail.com', '+639919612457', NULL, '2026-07-07', 1, 'Destination: Japan\nTravel Type: tour-package\nBudget: 10k-20k\nHotel Preference: budget\nInterests: city-tour\n\nHow did you hear about us: TikTok', '', '', 0.00, '₱', 'confirmed', 'paid', 'Inquiry Only', NULL, NULL, 0, 0, 0, 1, '2026-07-06 07:07:01', '2026-07-08 08:48:57', NULL, 'PENDING', 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1),
(68, 2, 'FO-836B1920260708', 'Foreign Destination', 'Chocolate Hills', '4D/3N', 0.00, 'Steven Rebancos', 'rebancossteven35@gmail.com', '+639919612457', NULL, '2026-07-17', 1, '', '', '', 0.00, '₱', 'completed', 'paid', 'gcash', '32341', NULL, 0, 1, 1, 0, '2026-07-08 04:35:36', '2026-07-08 08:48:57', NULL, 'APPROVED', 0, 1, 'HeyDream Travel and Tours', 31, 'Chocolate Hills', 'foreign_destination', NULL, NULL, NULL, NULL, NULL, NULL, 1),
(71, 2, 'FO-80AF0520260713', 'Foreign Destination', 'Chocolate Hills', '4D/3N', 6700.00, 'Steven Rebancos', 'rebancossteven35@gmail.com', '+639919612457', NULL, '2026-07-14', 1, '', NULL, NULL, 6700.00, '₱', 'confirmed', 'paid', 'gcash', '12343', 'uploads/receipts/REC_6a5494f80a39c_20260713.jpg', 0, 0, 0, 0, '2026-07-13 07:34:16', '2026-07-13 10:56:31', '2026-07-13 07:40:50', 'PENDING', 0, 1, 'HeyDream Travel and Tours', 31, 'Chocolate Hills', 'foreign_destination', NULL, NULL, NULL, NULL, NULL, NULL, 1),
(72, 2, 'FO-D33C2520260713', 'Foreign Destination', 'Beach Party', '4D/3N', 999.00, 'Steven Rebancos', 'rebancossteven35@gmail.com', '+639919612457', NULL, '2026-07-22', 1, '', NULL, NULL, 999.00, '₱', 'confirmed', 'paid', 'gcash', '32341', NULL, 0, 0, 0, 0, '2026-07-13 07:47:09', '2026-07-13 11:11:08', '2026-07-13 11:11:08', 'PENDING', 0, 1, 'HeyDream Travel and Tours', 30, 'Beach Party', 'foreign_destination', NULL, NULL, NULL, NULL, NULL, NULL, 1);
...
(12, 'FO-CA96BF20260713', 'uploads/booking_docs/FO-CA96BF20260713_1783925955_6a548cc35adbe.jpg', 'bali.jpg', '2026-07-13 06:59:15'),
(13, 'FO-CA96BF20260713', 'uploads/booking_docs/FO-CA96BF20260713_1783925955_6a548cc369881.jpg', 'bambike 2.jpg', '2026-07-13 06:59:15'),
(14, 'FO-CA96BF20260713', 'uploads/booking_docs/FO-CA96BF20260713_1783925955_6a548cc374b04.jpg', 'airline.jpg', '2026-07-13 06:59:15');
...
INSERT INTO `cruises` (`id`, `cruise_code`, `title`, `short_description`, `full_description`, `duration`, `featured_image`, `gallery`, `departure_port`, `destinations`, `route`, `ship_name`, `cruise_line`, `room_types`, `amenities`, `itinerary`, `ship_description`, `base_price`, `price_per_person`, `promo_price`, `inclusions`, `exclusions`, `departure_date`, `return_date`, `booking_deadline`, `available_slots`, `status`, `required_documents`, `travel_requirements`, `health_requirements`, `cancellation_policy`, `refund_policy`, `terms_conditions`, `category`, `destination_type`, `tags`, `highlights`, `promo_text`, `rating`, `feedback_count`, `is_published`, `is_featured`, `created_at`, `updated_at`, `partner_id`, `partner_company`) VALUES
(4, 'CRS-2026', 'Royal Caribbean Wonder of the Seas', '', 'mnbvcxz', '3D/2N', 'uploads/cruise_1779419748.jpg', '[\"uploads\\/cruise_gallery_1779076069_0.jpg\",\"uploads\\/cruise_gallery_1779076069_1.jpg\",\"uploads\\/cruise_gallery_1779076069_2.jpg\",\"uploads\\/cruise_gallery_1779076095_0.jpg\",\"uploads\\/cruise_gallery_1779076095_1.png\",\"uploads\\/cruise_gallery_1779076095_2.jpg\"]', '', '', '', 'zxcvbgd', 'vghmnx', '', 'Food', 'Day 1: Japan\r\nDay 2: China', '', 10000.00, 0.00, 1000.00, '', '', '2026-05-19', '2026-05-20', '2026-05-21', 0, 'Available', '', '', '', '', '', '', 'Cruise Package', 'International', 'fas fa-ship', '', '', 0.0, 0, 1, 0, '2026-05-18 02:37:49', '2026-05-22 05:41:31', NULL, NULL),
(5, 'CR-HK-004', 'Hong Kong Ocean Adventure', '', '', '3D2N', 'uploads/cruise_1779431054.jpg', '[]', 'Kai Tak Cruise Terminal, Hong Kong', '', '', 'Dream Cruises – Genting Dream', '', '', '', NULL, '', 42999.00, 0.00, 42000.00, '', '', NULL, NULL, NULL, 0, 'Available', '', '', '', '', '', '', '', 'International', 'Ocean View', '', '', 0.0, 0, 1, 0, '2026-05-22 06:24:14', '2026-05-22 06:24:14', NULL, NULL);
...
INSERT INTO `partner_applications` (`id`, `company_name`, `contact_person`, `email`, `phone`, `website`, `business_type`, `message`, `password`, `status`, `rejection_reason`, `approved_at`, `created_at`, `updated_at`, `is_banned`, `ban_until`) VALUES
(1, 'HeyDream Travel and Tours', 'Steven Fernandez Rebancos', 'rebancossteven35@gmail.com', '09919612457', '', 'Travel Agency', '', '$2y$10$3.PS8o8/tpjOesGCMN6AcO2cELKuh2YfE197z8.C7Zi3hK1N5f9ai', 'approved', NULL, '2026-07-01 16:48:39', '2026-07-01 08:48:21', '2026-07-07 03:04:48', 0, NULL),
(2, 'HeyDream Travel and Tours', 'Rebancos, Steven', 'asuelajohnkostya@gmail.com', '09919612457', '', 'Hotel / Resort', '', '$2y$10$HhjgJak5HUfvg.qiRVHy/.h3kvVIATm7F6HEKcSUpFoAbFtPWK4km', 'approved', NULL, '2026-07-06 16:22:37', '2026-07-06 08:20:46', '2026-07-06 08:25:29', 0, NULL);

-- --------------------------------------------------------

--
-- Table structure for table `partner_package_uploads`
--

CREATE TABLE `partner_package_uploads` (
  `id` int(11) NOT NULL,
  ...
  `price` decimal(10,2) DEFAULT 0.00,
  `description` text DEFAULT NULL,
  `upload_status` varchar(30) DEFAULT 'approved',
  `created_at` timestamp NOT NULL DEFAULT current_timestamp(),
  `updated_at` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp(),
  `image_path` varchar(500) DEFAULT NULL,
  `is_active` tinyint(4) DEFAULT 1,
...
INSERT INTO `partner_profiles` (`id`, `partner_id`, `business_display_name`, `bio`, `description`, `phone`, `address`, `city`, `country`, `website`, `operating_hours`, `logo_path`, `banner_image_path`, `specialties`, `years_in_business`, `team_size`, `certifications`, `social_media_links`, `is_verified`, `created_at`, `updated_at`) VALUES
(1, 1, 'Nevets Neotechs', 'I love travel', 'sfsf', '09919612457', '#173 Alley 14 P. ROSALES ST. STA.ANA PATEROS METRO MANILA', 'PATEROS', 'Philippines', 'https://heydreamtravel.com', 'Monday - Friday', 'uploads/partner-profiles/1783404052_6a4c961455cc4.jpg', 'uploads/partner-profiles/1783402857_6a4c9169be7c3.jpg', 'Travel Tours', 2, 1, 'wala\r\nwala', 'hey', 0, '2026-07-03 06:21:58', '2026-07-09 05:08:18');

-- --------------------------------------------------------

--
-- Table structure for table `partner_support_reports`
--

CREATE TABLE `partner_support_reports` (
  `id` int(11) NOT NULL,
  `partner_id` int(11) NOT NULL,
...
INSERT INTO `reported_issues` (`id`, `name`, `email`, `contact`, `category`, `severity`, `description`, `status`, `created_at`, `subject`, `screenshot_path`, `partner_id`) VALUES
(6, 'Steven Rebancos', 'rebancossteven35@gmail.com', '09919612457', 'Payment Problem', 'Critical', 'Subject: ascac\n\nascac', 'Pending', '2026-07-08 06:49:22', 'ascac', 'uploads/reports/report_20260708_084922_3633.jpg', NULL);
...
INSERT INTO `users` (`id`, `full_name`, `title`, `email`, `password`, `phone`, `dob`, `country`, `profile_pic`, `provider`, `provider_id`, `email_verified`, `verification_token`, `is_active`, `created_at`, `updated_at`, `marketing_consent`, `is_banned`, `ban_until`) VALUES
(2, 'Steven Rebancos', '', 'rebancossteven35@gmail.com', '$2y$10$GxuJuUtpxP.stJPhOSXGV.EsCyNCSN4opDVzEcruDNmJQiQkAAZXy', '09919612457', '0000-00-00', '', 'images/profiles/user_2_1777279274.jpg', 'google', '103132773064888483350', 1, NULL, 1, '2026-04-01 18:15:03', '2026-07-07 08:59:49', 1, 0, NULL),
(4, 'Mark Steve Socnaber', NULL, 'stevenrebancos860@gmail.com', '$2y$10$Dkrjpz0bMnw597IjkS4OzehzWMLoLy4IkyIIqgpBBqMUJCAIsC5fa', '09121597845', NULL, NULL, NULL, 'google', '102253844366003475698', 0, 'a92b28575bc5d03bc7261ec436d9d971d56afbfbb2e7715b1786f193bee1ee64', 1, '2026-04-01 19:33:57', '2026-05-25 04:00:29', 1, 0, NULL),
(5, 'Tibenn', NULL, 'sfrebancos@paterostechnologicalcollege.edu.php', '$2y$10$UaJTrp9MW9pgy6upPNOg.OxuPGK6HYr8xpALViI1jC4qBToDMgL.C', '09919612457', NULL, NULL, NULL, 'email', NULL, 0, 'e5847d243105a2d7e3b61234a9d4a79a61c3547a173e221a730cd24482f5d90a', 1, '2026-04-01 19:40:52', '2026-05-18 06:47:39', 1, 0, NULL),
(6, 'Angela Lou Dela Cruz', '', 'angelaloudelacruz7@gmail.com', '$2y$10$9pddPqsf9Uf9ocdBFnqvKOX.UdLv3lPSk4oe04pn.LCUEcCg2xKqq', '09463435820', '0000-00-00', '', 'images/profiles/user_6_1778614317.jpg', 'google', '105239986787392675136', 0, '0aa9d9ea2485349895b13bc4448c31d4167813b7fcf173186575dca734786a14', 1, '2026-05-12 19:29:19', '2026-05-22 06:36:46', 1, 0, NULL);
...
(157, 2, '19d2291b71bd02ee0e3d602acbd95ef9ec552363cb62a70a9f45a8388545741f', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/149.0.0.0 Safari/537.36 Edg/149.0.0.0', '2026-06-30 03:35:29', '2026-06-29 01:35:29'),
(158, 2, 'c80d9fe081f847157807c96b80fcb855de5a187763a1d1fd4f120f959a3e4af6', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/149.0.0.0 Safari/537.36 Edg/149.0.0.0', '2026-06-30 08:29:27', '2026-06-29 06:29:27'),
(159, 2, 'a0167f1f0c38f32346cc91e117ad943c18eeaa6382b01f8ec4c63054e613d6ab', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/149.0.0.0 Safari/537.36 Edg/149.0.0.0', '2026-06-30 11:13:16', '2026-06-29 09:13:16'),
(160, 2, '07140253a1c05d8eb1e18ca4d8347f5fe2bb78112f375e71e4188aab85681ee3', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/149.0.0.0 Safari/537.36 Edg/149.0.0.0', '2026-07-01 07:16:49', '2026-06-30 05:16:49'),
(161, 2, '4008b33466817284ed115434ed1567199489ee28e1733f269448736cab25fe83', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/149.0.0.0 Safari/537.36 Edg/149.0.0.0', '2026-07-02 05:42:33', '2026-07-01 03:42:33'),
(162, 2, 'bf73c23db403bdffbe78a4360918a9b10dfc45563df01bb678eb6572495038a8', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/149.0.0.0 Safari/537.36 Edg/149.0.0.0', '2026-07-02 08:17:50', '2026-07-01 06:17:50'),
(163, 2, '4168a62e2f10557bfe8c78e24734ef2a4c940fb7a6e9b1e2d91fe19fbe76c43c', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/149.0.0.0 Safari/537.36 Edg/149.0.0.0', '2026-07-02 08:54:01', '2026-07-01 06:54:01'),
(164, 2, '97c55bac543f075368eae062b369b93656da4ab6f2083403447b2c7732812559', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/149.0.0.0 Safari/537.36 Edg/149.0.0.0', '2026-07-02 11:04:14', '2026-07-01 09:04:14'),
(165, 2, '1abef73e781d585ff185a86451a73a75260a1c11105b821de36d2b2d34b50b9b', '::1', 'Mozilla/5.0 (iPhone; CPU iPhone OS 18_5 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/18.5 Mobile/15E148 Safari/604.1 Edg/150.0.0.0', '2026-07-04 08:11:08', '2026-07-03 06:11:08'),
(168, 2, '8f58860dd0868bea7ae46321a4cc097d1e710833cd609e8accf2ce52278f604f', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36 Edg/150.0.0.0', '2026-07-08 10:59:49', '2026-07-07 08:59:49'),
(169, 2, 'b01ec5dc184c4a992c14c24538a5d6827258a9113e248b978532f79e35f269f8', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36 Edg/150.0.0.0', '2026-07-09 03:15:44', '2026-07-08 01:15:44'),
(170, 2, '8669f13b26d757870ccd1576ef13f184a69d291988f46461413aee2c24c9f523', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36 Edg/150.0.0.0', '2026-07-09 03:30:33', '2026-07-08 01:30:33'),
(171, 2, '9f09ce491e4e7d5ac99497688475eae2624a7e8e79737b6cfe87f04f7606974d', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36 Edg/150.0.0.0', '2026-07-09 04:01:18', '2026-07-08 02:01:18'),
(172, 2, '792924cb23fc12d13ee2794f5ab14ac68a268370913f1e82a8d66af3922451f9', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36 Edg/150.0.0.0', '2026-07-14 14:16:19', '2026-07-13 06:16:19'),
(173, 2, '734bcce06de58e039594142339fcd69198a80d23279fb2014d649953f3393f25', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36 Edg/150.0.0.0', '2026-07-14 14:57:35', '2026-07-13 06:57:35');
...
CREATE TABLE `user_vouchers` (
  ...
  `is_collected` tinyint(1) DEFAULT 1,
...
INSERT INTO `user_vouchers` (`id`, `user_id`, `voucher_id`, `is_collected`, `is_used`, `collected_at`, `used_at`) VALUES
(11, 2, 19, 1, 1, '2026-07-01 07:05:27', '2026-07-08 01:30:52'),
(12, 2, 21, 1, 1, '2026-07-04 16:10:28', '2026-07-08 01:35:33'),
(13, 2, 20, 1, 1, '2026-07-04 16:16:10', '2026-07-08 01:16:24'),
(14, 2, 23, 1, 1, '2026-07-04 16:25:42', '2026-07-13 06:58:04'),
(15, 2, 22, 1, 1, '2026-07-04 16:25:44', '2026-07-07 09:00:19');
...
INSERT INTO `visas` (`id`, `title`, `category`, `description`, `price`, `currency`, `processing_time`, `requirements`, `icon_type`, `icon_value`, `is_active`, `display_order`, `created_at`, `updated_at`, `disclaimer`, `important_notes`, `visa_status`, `partner_id`, `partner_company`) VALUES
(1, 'Singapore', 'Asia', 'e-Arrival Card (SGAC) & complete entry document assistance.', 999.00, '₱', 'Visa-Free (30 Days)', '[\"Passport valid for 6 months\",\"SG Arrival Card (SGAC)\",\"Confirmed Round-trip Ticket\",\"Confirmed Hotel Booking\",\"Proof of Sufficient Funds\"]', 'image', 'https://flagcdn.com/w80/sg.png', 1, 1, '2026-04-14 14:09:05', '2026-04-14 14:47:52', NULL, NULL, 'required', NULL, NULL),
(2, 'Malaysia', 'Asia', 'Digital Arrival Card (MDAC) and entry proof preparation.', 999.00, '₱', 'Visa-Free (30 Days)', '[\"Passport valid for 6 months\",\"Malaysia Digital Arrival Card (MDAC)\",\"Confirmed Round-trip Ticket\",\"Confirmed Hotel Booking\"]', 'image', 'https://flagcdn.com/w80/my.png', 1, 2, '2026-04-14 14:09:05', '2026-04-14 14:09:05', NULL, NULL, 'required', NULL, NULL),
(3, 'Thailand', 'Asia', 'Proof of funds documentation and entry assistance.', 999.00, '₱', 'Visa-Free (30 Days)', '[\"Passport valid for 6 months\",\"Confirmed Round-trip Ticket\",\"Confirmed Hotel Booking\",\"Proof of Funds (Min. 10,000 THB equivalent)\"]', 'image', 'https://flagcdn.com/w80/th.png', 1, 3, '2026-04-14 14:09:05', '2026-04-14 14:09:05', NULL, NULL, 'required', NULL, NULL),
(4, 'Indonesia', 'Asia', 'Electronic Customs Declaration (e-CD) & entry proofs.', 999.00, '₱', 'Visa-Free (30 Days)', '[\"Passport valid for 6 months\",\"e-Customs Declaration (e-CD)\",\"Confirmed Round-trip Ticket\",\"Confirmed Hotel Booking\"]', 'image', 'https://flagcdn.com/w80/id.png', 1, 4, '2026-04-14 14:09:05', '2026-04-14 14:09:05', NULL, NULL, 'required', NULL, NULL),
(5, 'Vietnam', 'Asia', 'Complete entry document preparation and proofs.', 999.00, '₱', 'Visa-Free (21 Days)', '[\"Passport valid for 6 months\",\"Confirmed Round-trip Ticket\",\"Confirmed Hotel\\/Tour Booking\"]', 'image', 'https://flagcdn.com/w80/vn.png', 1, 5, '2026-04-14 14:09:05', '2026-04-14 14:09:05', NULL, NULL, 'required', NULL, NULL),
(6, 'Schengen Visa', 'Europe', 'Travel to 27 European countries with a single visa. Expert assistance with documentation.', 8999.00, '₱', 'Standard Processing', '[\"Passport valid for 6 months\",\"2x2 photo with white background\",\"Detailed Flight Itinerary\",\"Confirmed Hotel Booking\",\"Bank Certificate (3-6 Months)\",\"Certificate of Employment\",\"Travel Insurance\"]', 'image', 'https://flagcdn.com/w80/eu.png', 1, 6, '2026-04-14 14:09:05', '2026-04-14 14:09:05', NULL, NULL, 'required', NULL, NULL),
(7, 'US Visa', 'North America', 'B1/B2 tourist visa assistance. Interview preparation and DS-160 form assistance.', 12999.00, '₱', 'Regular Processing', '[\"Passport valid for 6 months\",\"2x2 photo (Recent, white background)\",\"DS-160 Confirmation\",\"Proof of strong ties to Philippines\",\"Financial Documents\",\"Employment Documents\"]', 'image', 'https://flagcdn.com/w80/us.png', 1, 7, '2026-04-14 14:09:05', '2026-04-14 14:09:05', NULL, NULL, 'required', NULL, NULL);
...
CREATE TABLE `vouchers` (
  ...
  `max_discounted_travelers` int(11) DEFAULT 0,
  `max_total_redemptions` int(11) DEFAULT 0,
  `max_redemptions_per_user` int(11) DEFAULT 1,
...
INSERT INTO `vouchers` (`id`, `voucher_name`, `voucher_code`, `description`, `discount_type`, `discount_value`, `minimum_spend`, `maximum_discount`, `max_discounted_travelers`, `max_total_redemptions`, `max_redemptions_per_user`, `start_date`, `end_date`, `status`, `priority`, `display_order`, `banner_image_url`, `color_theme`, `audience`, `collection_method`, `created_at`, `updated_at`) VALUES
(19, 'asd', 'ASD', 'asd', 'percentage', 10.00, 0.00, NULL, 0, 0, 1, '2026-07-02 15:01:00', '2026-07-23 15:10:00', 'active', 0, 0, NULL, '#003580', 'everyone', 'user_collect', '2026-07-01 07:01:40', '2026-07-04 15:58:31'),
(20, 'qeeqe', 'QWEQE', 'qweqe', 'percentage', 34.00, 0.00, NULL, 0, 0, 1, '2026-07-04 23:59:00', '2026-07-28 23:59:00', 'active', 0, 0, NULL, '#003580', 'everyone', 'user_collect', '2026-07-04 15:59:16', '2026-07-04 16:09:57'),
(21, 'testing', 'TESTUNG', 'asdad', 'percentage', 19.00, 0.00, NULL, 0, 0, 1, '2026-07-05 00:10:00', '2026-07-27 00:10:00', 'active', 0, 0, NULL, '#003580', 'everyone', 'user_collect', '2026-07-04 16:10:20', '2026-07-04 16:10:20'),
(22, 'asdasdasd', 'ASDADA', '', 'percentage', 12.00, 0.00, NULL, 0, 0, 1, '2026-07-05 00:23:00', '2026-07-22 00:23:00', 'active', 0, 0, NULL, '#003580', 'everyone', 'user_collect', '2026-07-04 16:24:04', '2026-07-04 16:24:04'),
(23, 'Summer Discount', 'SUMMER123', 'asd', 'percentage', 34.00, 0.00, NULL, 0, 0, 1, '2026-07-05 00:24:00', '2026-07-24 04:24:00', 'active', 0, 0, NULL, '#003580', 'everyone', 'user_collect', '2026-07-04 16:24:26', '2026-07-08 04:59:38');

-- --------------------------------------------------------

--
-- Table structure for table `voucher_packages`
--
...
INSERT INTO `voucher_redemptions` (`id`, `voucher_id`, `user_id`, `booking_id`, `redemption_amount`, `redemption_date`) VALUES
(3, 22, 2, 0, 108.00, '2026-07-07 09:00:19'),
(4, 20, 2, 0, 339.66, '2026-07-08 01:16:24'),
(5, 19, 2, 0, 99.90, '2026-07-08 01:30:52'),
(6, 21, 2, 0, 189.81, '2026-07-08 01:35:33'),
(7, 23, 2, 70, 2278.00, '2026-07-13 06:58:04');

-- --------------------------------------------------------

--
-- Table structure for table `voucher_targets`
--
...
--
-- Indexes for table `partner_package_uploads`
--
ALTER TABLE `partner_package_uploads`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_partner_uploads_partner` (`partner_id`),
  ADD KEY `idx_partner_uploads_status` (`upload_status`);
...
--
-- Indexes for table `partner_support_reports`
--
ALTER TABLE `partner_support_reports`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `voucher_packages`
--
ALTER TABLE `voucher_packages`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `voucher_id` (`voucher_id`,`target_type`,`package_id`);
...
--
-- Indexes for table `voucher_targets`
--
ALTER TABLE `voucher_targets`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `voucher_id` (`voucher_id`,`target_type`);
...
--
-- AUTO_INCREMENT for table `partner_package_uploads`
--
ALTER TABLE `partner_package_uploads`
...
--
-- AUTO_INCREMENT for table `partner_support_reports`
--
ALTER TABLE `partner_support_reports`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `voucher_packages`
--
ALTER TABLE `voucher_packages`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
-- AUTO_INCREMENT for table `voucher_targets`
--
ALTER TABLE `voucher_targets`
...
--
ALTER TABLE `partner_profiles`
  ADD CONSTRAINT `partner_profiles_ibfk_1` FOREIGN KEY (`partner_id`) REFERENCES `partner_applications` (`id`) ON DELETE CASCADE;
...
--
-- Constraints for table `voucher_packages`
--
ALTER TABLE `voucher_packages`
  ADD CONSTRAINT `voucher_packages_ibfk_1` FOREIGN KEY (`voucher_id`) REFERENCES `vouchers` (`id`) ON DELETE CASCADE;

--
-- Constraints for table `voucher_redemptions`
--
ALTER TABLE `voucher_redemptions`
  ADD CONSTRAINT `voucher_redemptions_ibfk_1` FOREIGN KEY (`voucher_id`) REFERENCES `vouchers` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `voucher_redemptions_ibfk_2` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE SET NULL;

--
-- Constraints for table `voucher_targets`
--
ALTER TABLE `voucher_targets`
  ADD CONSTRAINT `voucher_targets_ibfk_1` FOREIGN KEY (`voucher_id`) REFERENCES `vouchers` (`id`) ON DELETE CASCADE;
COMMIT;
