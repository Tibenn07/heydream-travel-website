                ...
                if (collageType === 'three' && images.length >= 3) {
                    collageHtml = `
                        <div class="collage-three">
                            <div class="collage-main">
                                <img src="${images[0] || ''}" alt="${escapeHtml(dest.name)}" onerror="this.onerror=null;this.src='https://via.placeholder.com/250x180?text=${escapeHtml(dest.name)}'">
                            </div>
                            <div class="collage-stack">
                                <img src="${images[1] || ''}" alt="${escapeHtml(dest.name)}" onerror="this.onerror=null;this.src='https://via.placeholder.com/150x90?text=${escapeHtml(dest.name)}'">
                                <img src="${images[2] || ''}" alt="${escapeHtml(dest.name)}" onerror="this.onerror=null;this.src='https://via.placeholder.com/150x90?text=${escapeHtml(dest.name)}'">
                            </div>
                        </div>
                    `;
                    ...
                    collageHtml = `
                        <div class="collage-half">
                            <img src="${images[0] || ''}" alt="${escapeHtml(dest.name)}" onerror="this.onerror=null;this.src='https://via.placeholder.com/200x180?text=${escapeHtml(dest.name)}'">
                            <img src="${images[1] || ''}" alt="${escapeHtml(dest.name)}" onerror="this.onerror=null;this.src='https://via.placeholder.com/200x180?text=${escapeHtml(dest.name)}'">
                        </div>
                    `;
                } else {
                    const imgSrc = images[0] || 'https://via.placeholder.com/400x250?text=' + encodeURIComponent(dest.name);
                    collageHtml = `<img src="${imgSrc}" alt="${escapeHtml(dest.name)}" style="width:100%; height:100%; object-fit:cover;" onerror="this.onerror=null;this.src='https://via.placeholder.com/400x250?text=${encodeURIComponent(dest.name)}'">`;
                }
            ...
            <div id="localStep2Content" class="step-content">
                <div class="booking-form-modal">
                    ...
                    <div class="booking-summary" style="margin-bottom: 20px; background: #f9f9f9;">
                        ...
                        <div class="summary-item discounted" id="localStepSummaryDiscountedRow" style="display:none;"><span>Discounted:</span><span id="localStepSummaryDiscounted">₱0</span></div>
